...
//	 */
//	@RequestMapping(value = "/addBag/{id}")
...
//	}
	...
	@RequestMapping(value = "/addBag")
	public List<BioDetails> getbags() {
		return service.getAllBags();
	}

	@RequestMapping(value = "/addBag", method = RequestMethod.POST)
	public BioDetails createBag(@RequestBody BioDetails bag) {
		return service.addbag(bag);
	}

	@RequestMapping(value = "/addBag/{id}")
	public ResponseEntity<Optional<BioDetails>> getBagById(@PathVariable(value = "id") long id) {
		Optional<BioDetails> bag = service.getBagById(id);
